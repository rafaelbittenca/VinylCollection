...
namespace Vinyl.DAL.Concrete
{
    ...
    public sealed class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(DbContext context)
        {
            ...
            Users = new UserRepository(_dbContext);             //??Revisar
            Auths = new AuthenticationRepository(_dbContext);   //??Revisar
        }

        public IArtistRepository Artists { get; private set; }
        public IRecordRepository Records { get; private set; }

        public IAuthenticationRepository Auths { get; private set; }    //??Revisar
        public IUserRepository Users { get; private set; }              //??Revisar
        /// <summary>
